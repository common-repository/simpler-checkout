...
// CODE COPIED FROM https://github.com/EFTEC/BladeOne AND DOWNGRADED TO PHP 7.0.* FOR COMPATIBILITY
...
/**
 * BladeTemplate - A Blade Template implementation in a single file
 *
 * @package   BladeTemplate
 * @author    Jorge Patricio Castro Castillo <jcastro arroba eftec dot cl>
 * @copyright Copyright (c) 2016-2021 Jorge Patricio Castro Castillo MIT License.
 *            Don't delete this comment, its part of the license.
 *            Part of this code is based in the work of Laravel PHP Components.
 * @version   4.1
 * @link      https://github.com/EFTEC/BladeTemplate
 */
class BladeService
{
    //<editor-fold desc="fields">

    /** @var int BladeTemplate reads if the compiled file has changed. If it has changed,then the file is replaced. */
     const MODE_AUTO = 0;
     ...
     *
     * @var int=[BladeTemplate::MODE_AUTO,BladeTemplate::MODE_DEBUG,BladeTemplate::MODE_SLOW,BladeTemplate::MODE_FAST][$i]
     */
    protected $mode;
     ...
     * @param int          $mode         =[BladeTemplate::MODE_AUTO,BladeTemplate::MODE_DEBUG,BladeTemplate::MODE_FAST,BladeTemplate::MODE_SLOW][$i]
     */
    ...
    public function showError($id, $text, $critic = false, $alwaysThrow = false)
    {
        ...
        if ($this->throwOnError || $alwaysThrow || $critic === true) {
            throw new \RuntimeException("BladeTemplate Error [$id] $text");
        } else {
            $msg= "<div style='background-color: red; color: black; padding: 3px; border: solid 1px black;'>";
            $msg.= "BladeTemplate Error [$id]:<br>";
     ...
     *
     * @return BladeService
     * @see \Simpler\Services\BladeService::setMode
     */
     ...
     * @return string
     *
     * @see \Simpler\Services\BladeService::compileStatements
     * @see \Simpler\Services\BladeService::compileExtends
     * @see \Simpler\Services\BladeService::compileComments
     * @see \Simpler\Services\BladeService::compileEchos
     */
                ...
                if (is_callable($fn)) {
                    ...
                    if (method_exists($instance, 'composer')) {
                        ...
                        if ($this->mode === self::MODE_DEBUG) {
                            $this->showError('evalComposer', "BladeTemplate: composer() added an incorrect method [$fn]", true, true);
                            return;
                        }
                        $this->showError('evalComposer', 'BladeTemplate: composer() added an incorrect method', true, true);
                        return;
                    }
                } else {
                    $this->showError('evalComposer', 'BladeTemplate: composer() added an incorrect method', true, true);
     ...
     * @return bool|string True if the operation was correct, or false (if not exception)
    ...
    /**
     * Get the mode of the engine.See BladeTemplate::MODE_* constants
     *
     ...
     *
     * @return $this
     * @see \Simpler\Services\BladeService::share
     */
    ...
    public function run($view = null, $variables = [])
    {
        ...
        $this->viewStack = null;
        if ($view === null) {
            $this->showError('run', 'BladeTemplate: view not set', true);
            return '';
        }
     ...
     *
     * @return string
     * @see \Simpler\Services\BladeService::setBaseUrl
     */
     ...
     *
     * @return string
     * @see \Simpler\Services\BladeService::getCanonicalUrl
     */
     ...
     *
     * @return string
     * @see \Simpler\Services\BladeService::getBaseUrl()
     */
     ...
     *
     * @return string
     * @see \Simpler\Services\BladeService::$aliasClasses
     */
     ...
     * @param string $result
     * @return string
     * @\Simpler\Services\BladeTemplateService::$pipeEnable
     */
